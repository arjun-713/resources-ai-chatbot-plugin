...
def test_retrieve_context_with_placeholders(mock_get_relevant_documents):
    ...
    def side_effect(query, model, logger, source_name, top_k):
...
def test_retrieve_context_multi_source_ranking(mock_get_relevant_documents):
    ...
    import api.services.chat_service
    original_tool_names = api.services.chat_service.CONFIG["tool_names"]
    api.services.chat_service.CONFIG["tool_names"] = {
    ...
    try:
        ...
        api.services.chat_service.CONFIG["tool_names"] = original_tool_names
